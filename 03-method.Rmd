...
percent_of_women <- read.csv("/Users/mandydavis/Desktop/Using R for Analysis/percent_of_women.csv", header = TRUE)
...
# percent_of_men data
percent_of_men <- read.csv("/Users/mandydavis/Desktop/Using R for Analysis/percent_of_men.csv", header = TRUE)
...
The ICT-GEP Thinkpiece does not offer an explanation regarding the consideration or removal of outliers. However, through a simple count of the countries listed in the Thinkpiece's reference data, it appears that only 79 countries were included in the analysis. 
