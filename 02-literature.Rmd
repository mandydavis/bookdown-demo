...
**The exact data files and R script used for this analysis can be found [here](https://github.com/mandydavis/ict-gep-re-analysis/tree/master/data-&-R-script). Reproduction is encouraged.**