...
ict_raw <- read.csv("/Users/mandydavis/Desktop/Using R for Analysis/ict.csv")
...
Before diving into the data, these maps offer a visual explanation of the ICT-GEP when using the analysis method from the UNESCO Thinkpiece.
...
ggi_raw <- read.csv("/Users/mandydavis/Desktop/Using R for Analysis/ggi.csv", header = TRUE)
